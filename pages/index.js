...
export default function Home() {
  ...
  const getData = () => {
    axios({
      url: "https://getpantry.cloud/apiv1/pantry/ecff2e4b-9f41-4557-8fde-9543d26f788f/basket/portfolioData",
      method: "GET",
    })
  ...
  return (isEmpty(data) ?
    (<div style={{backgroundColor: darkMode ? '3F0071' : 'B4CDE6', height: '100%', width: '100%', position: 'absolute'}}><ContentLoader
      speed={2}
      width={'100%'}
      height={'100%'}
      viewBox="0 0 400 160"
      ...
      style={{ padding: '10%', backgroundColor: darkMode ? '3F0071' : 'B4CDE6' }}
    >
        ...
        <main className='px-5 md:px-20 lg:px-40 dark:bg-gray-900'>
          <section className='min-h-screen'>
            ...
            <div className=' text-5xl flex justify-center gap-16 py-3 text-gray-600'>
              ...
              <a href={data.github} target="_blank" rel="noopener noreferrer"><AiFillGithub className=' dark:fill-gray-300' /></a>
              <a href={data.twitter} target="_blank" rel="noopener noreferrer"><AiFillTwitterCircle className=' dark:fill-gray-300' /></a>
              <a href={data.instagram} target="_blank" rel="noopener noreferrer"><FaInstagramSquare className=' dark:fill-gray-300' /></a>
            </div>
            <div className='flex justify-center gap-16 py-3 text-gray-600 sm:text-sm'>
              <div className='mx-auto flex flex-wrap px-10'>
                <div className='flex justify-center'>
                  <a className='flex justify-center text-xl dark:text-white px-3  ' data-toggle="tooltip" title={'Copy'} onClick={() => { navigator.clipboard.writeText('8754698456'); notify("info", "Copied") }}><FaPhoneSquareAlt className='text-3xl px-1 text-gray-600 dark:fill-gray-300' />{data.phone}</a>
                </div>
                <div className='flex justify-center'>
                  <a className='flex justify-center text-xl dark:text-white px-3 ' data-toggle="tooltip" title={'Copy'} onClick={() => { navigator.clipboard.writeText('nivas65536@gmail.com'); notify("info", "Copied") }}><IoMdMail className='text-3xl px-1 text-gray-600 dark:fill-gray-300' />{data.email}</a>
                </div>
              </div>
            </div>
          ...
          <section>
            <div className='text-center p-20'>
              {!isEmpty(quote) &&
              <>
              <p className='text-xl py-5 leading-8 text-gray-800 md:text-xl dark:text-violet-400'>Anime : {quote?.anime}</p>
              <p className='text-md py-1 leading-8 text-gray-800 md:text-xl dark:text-violet-400'>{quote?.quote}</p>
              <p className='text-md py-3 leading-8 text-gray-800 md:text-xl dark:text-violet-400'>~{quote?.character}</p>
              </>}
              <h3 className='text-xl py-5 font-AstroSpace dark:text-white'>Thanks</h3>
            </div>
          </section>
        </main>
      </div>
